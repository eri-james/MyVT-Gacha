import type { TrainableStat, SparkQuality, RunGrade, StreamOutcome, CheckpointOutcome, LiveonPhase, LiveonStage, Rarity } from './common';
import type { CharacterStats, TrainedStats, RosterEntry, Sparks } from './character';
...
export interface LiveonRun {
        ...
        generation?: number; // spark generation count (1 = no inheritance)
...
export interface ExcursionChoice {
        ...
        label: string;
        narrative: string;
        statRequirement?: { stat: TrainableStat; threshold: number };
        lockoutLabel?: string;
}
